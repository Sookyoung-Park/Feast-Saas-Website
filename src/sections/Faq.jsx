        ...
        <div className="container relative z-2 py-28">
          <div>
            <h3 className='h3 max-md:h5 max-w-640 max-lg:max-w-md mb-7 text-p7'>
              Questions? <br/>We’ve Got the Answers.
            </h3>
            <p className='body-1 text-p6 max-lg:max-w-sm'>You've got questions, we've got answers</p>
          </div>
          
          {/* faq logo and lists */}
          <div className='relative z-2 bg-s3/5 mt-20 rounded-7xl'>
            <div className='container flex gap-10 msx-lg:block'>
                <div className='rounded-half absolute -top-10 left-[calc(50%-40px)] z-4 flex size-20 items-center justify-center border-2 border-s2/10 bg-white shadow-500'>
                  <img 
                  src="/images/feast-faq-logo.svg" 
                  alt="logo"
                  className='size-1/2'/>
                </div>
                ...
                <div className='relative flex-1 lg:pt-24 max-lg:pt-24'>
